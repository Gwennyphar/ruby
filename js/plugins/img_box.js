...
window.onload = function() {
    ...
    idpopup_img_box.style.width = '75%';
    idpopup_img_box.style.height = '0%';
    ...
    idpopup_img_box.style.backgroundColor = '';
};
...
function img_box(self) {
    ...
    img_img_box.onload = function() {
        ...
        if (himg_img_box < hwin_img_box) {
            ...
            idpopup_img_box.style.paddingLeft = padtop_img_box + 'px';
        }
        else {
            idpopup_img_box.style.paddingTop = '130px';
            idpopup_img_box.style.paddingLeft = '630px';
        }
